...
CREATE TABLE `table1` (
  `종류` varchar(2) DEFAULT NULL,
  `요리명` varchar(8) DEFAULT NULL,
  `분량` varchar(3) DEFAULT NULL,
  `재료` varchar(299) DEFAULT NULL,
  `과정` varchar(569) DEFAULT NULL
